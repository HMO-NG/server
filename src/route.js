...
import bands from './controller/band-controller.js';

const router = [provider, auth, healthPlan, nhisService, nhisEnrollee, getHealthCheck, forms,privateCompany,privateEnrollees,docs,privateClaims,bands];
